...
>
	<div class="container mx-auto px-4 py-4 md:px-6">
		<div class="relative flex items-center justify-center">
			...
			<div class="flex items-center md:space-x-10 gap-4">
				<a href="#top" class="text-sm font-normal md:text-lg  md:font-bold text-gray-900 transition hover:text-gray-600"
					>Contact</a
				><a
					href="#about"
					class="text-sm font-normal md:text-lg  md:font-bold whitespace-nowrap text-gray-900 transition hover:text-gray-600"
					>About Us</a
				>
				<a
					href="#farmers-market"
					class="text-sm font-normal md:text-lg  md:font-bold whitespace-nowrap text-gray-900 transition hover:text-gray-600"
					>Farmers Market</a
				><a href="#catering" class="text-sm font-normal md:text-lg  md:font-bold text-gray-900 transition hover:text-gray-600"
					>Catering</a
				>
				<a
